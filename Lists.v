...
Fixpoint included (s1 : bag) (s2 : bag) : bool :=
  ...
  | x :: xs => 
    ...
    | true  => included xs (remove_one x s2)
    | false => false
    end
  end.
...
Proof.
  intros l default. destruct l as [|l'].
  - simpl. reflexivity.
  - simpl. reflexivity.
Qed.
...
(** The [update] function overrides the entry for a given key in a
  ...
  (* AC Note: This seems a bit concerning since partial_map really doesn't need to keep track of it?*)
