...
(* AC Note: Inference-able argument to function. *)
Fixpoint repeat''' {X : Type} (x : X) (count : nat) : list X :=
  match count with
  | 0        => nil
...
Theorem map_app: forall (X Y: Type) (f : X -> Y) (l1 : list X) (l2 : list X),
...
Proof.
  ...
  induction l.
  - simpl. reflexivity.
  - simpl. rewrite <- map_app. simpl. rewrite IHl. reflexivity.
Qed.
(** [] *)
